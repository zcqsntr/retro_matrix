...
OBJECTS=run_retro_matrix.o retro_matrix.o menu.o start_menu.o snake.o space.o loop.o tetris.o game_of_life.o rule_30.o ant.o


all : run_retro_matrix

run_retro_matrix: $(OBJECTS) $(RGB_LIBRARY) $(EVDEV_LIBRARY)
