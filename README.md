...
* LED matrix, preferably 64x64 https://shop.pimoroni.com/products/rgb-led-matrix-panel?variant=3029531983882
...
* (recommended) matrix hat or bonnet, so you don't have to wire it to the GPIO pins yourself https://shop.pimoroni.com/products/adafruit-rgb-matrix-bonnet-for-raspberry-pi
